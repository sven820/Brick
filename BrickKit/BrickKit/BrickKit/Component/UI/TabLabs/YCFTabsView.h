...
- (void)tabsView:(YCFTabsView *)tabsView didSelectedTabItemAtIndex:(NSInteger)index;

#warning todo
- (void)tabsView:(YCFTabsView *)tabsView didDoubleClickedTabItemAtIndex:(NSInteger)index;
@end
